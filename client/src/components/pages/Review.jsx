    ...
    return (
        <div>
            ...
            <div className='container mt-5 rounded' style={{ background: "#198754" }}>
                <div className='row'>
                    <div className='col-lg-7 py-sm-5 d-flex justify-content-center text-center'>
                        <div className='my-sm-5 my-3'>
                            <h2 className='mt-sm-5 mt-2'>Get Free Video | Call Consultancy</h2>
                            <h1 className='text-white f_25_export'>Schedule a virtual meeting <br />with an expert</h1>
                    ...
                    <div className='col-lg-5'>
                        <div className='card px-sm-5 px-3 m-sm-5' style={{ width: "auto" }}>
                            <div className="row my-3 ">
                                ...
                                <div className="mb-3 row">
                                    <div className="col-sm-12">
                                        <button className="btn px-5 text-white float-end " style={{ background: "#198754" }} onClick={SubmitData}><b>Book</b></button>
                                    </div>
                                </div>
                            </div>
                        </div>
