...
const ServicePage = () => {
    const [activeSuccessModal, setActiveSuccessModal] = useState(false); // State to track active section
    ...
    return (
        <>
            <Header closeModal={closeModal} modalActive={modalActive} setModalActive={setModalActive} />
            {
                ...
                <div>
                    <div className='container-fluid' style={{ background: `url(${selectServicedata && selectServicedata.images})`, backgroundSize: "cover" }}>
                                                ...
                                                data?.image ?
                                                    <>
                                                        ...
                                                        <div className='col-sm-5  pt-4 text-center'>
                                                            <img src={`${data.image}`} alt="condition" height="auto" width='100%' />
                                                        </div>
                                                        {
            ...
            }
            {
                ...
                <div class="modal fade show" id="exampleModal" tabindex="-1" role="dialog" style={{ display: 'block' }}>
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title text-green" id="exampleModalLabel">Order Create Successfully!!</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" onClick={() => { setActiveSuccessModal(false) }}>
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body text-center">
                                <h4 className="heading_main" style={{fontSize:"20px"}}>Thank you for Purchasing The package</h4>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal" onClick={() => { setActiveSuccessModal(false) }}>Close</button>
