                                    ...
                                    return (
                                        <>
                                            <div class="card single_post">
                                                <div class="body">
                                                    <div class="img-post">
                                                        <img class="d-block img-fluid" src={`${item.image && item.image}`} alt="First slide" />
                                                    </div>
                                                    <h3 className='heading_main'>{item.heading}</h3>
                                                    {/* {
                                                        item.link && 
                                                    ...
                                                    <p>
                                                    <pre style={{ width: '100%', whiteSpace: 'pre-wrap', textAlign: 'justify', fontFamily: 'inherit', fontSize: "18px", fontWeight: "400" }}>
