                        ...
                        <nav className="navbar navbar-expand-xl navbar-light  " style={{ padding: "9px" }}>
                            <div className="container-fluid textSize ">
                                ...
                                <div className="collapse navbar-collapse" id="navbarSupportedContent1">
                                    <ul className="navbar-nav me-auto mb-2 mb-lg-0 d-flex" style={{ alignItems: "center" }}>
                                        <li className="nav-item ps-4 pe-3 " style={{ width: "230px" }}>
                                            <a className='nav-link    header_active' href='/documents' ><b>Document Formats</b></a>
                                        </li>
                                        <span className='d-xl-block d-none' style={{ color: "white" }}>|</span>
                                        <li className="nav-item ps-4 pe-3 ">
                                            <a className='nav-link    header_active' ><b>Franchise</b></a>
                                        </li>
                                        <span className='d-xl-block d-none' style={{ color: "white" }}>|</span>
                                        <li className="nav-item ps-4 pe-3 " style={{ width: "200px" }}>
                                            <a className='nav-link    header_active' href='/blog'  ><b>Knowledge Hub</b></a>
                                        </li>
                                        <span className='d-xl-block d-none' style={{ color: "white" }}>|</span>
                                        <li className="nav-item ps-4 pe-3 " style={{ width: "266px" }}>
                                            <a className='nav-link    header_active' ><b> <span style={{ display: "flex", alignItems: "center" }} className='cursor_p mr_20'><IoCallOutline style={{ marginRight: "3px" }} /> <FaWhatsapp style={{ marginRight: "3px" }} /><span style={{ display: 'flex', flexDirection: "column" }}><span>+91-8077425868</span><span>+91-9716970019</span></span></span>
                                            </b></a>
                                        </li>
                                        <span className='d-xl-block d-none' style={{ color: "white" }}>|</span>
                        ...
                        <section className="vh-100 container_body">
                            <div className="container py-5 h-100">
                                <div className="row px-3 d-flex align-items-center justify-content-center h-100">
                                    <div className="col-md-10 w-70 col-lg-10 col-xl-9 card flex-row mx-auto px-0 " >
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div class="form-box px-3">
                                                ...
                                                <div class="form-input">
                                                    ...
                                                    <textarea value={details} onChange={(e) => { setDetails(e.target.value) }} placeholder="Details" tabindex="10" style={{ borderRadius: "20px", padding: "10px", width: "100%", fontSize: "10px", minHeight: "90px" }} className='textarea-focus' />
                                                </div>
