    ...
    return (
        <div className='container-fluid'>
            <div className="mt-5 pt-5 bg-light">
                ...
                <div className="row py-sm-5 py-2 px-sm-5 px-2 textSize" >
                    <div className="col-md-6 px-sm-5 ">
                        <div className='row' style={{ display: 'flex' }}>
                            <div className='col-md-6' style={{ display: 'flex', flexDirection: 'column' }}>
                                <div className='card mt-5 mx-3 py-3 text-center card2' style={{ flex: '1' ,width:'auto' }}>
                                    <h2><FaLocationDot /></h2>
                                    <h3>Our Address</h3>
                        ...
                        <div className='row' style={{ display: 'flex' }}>
                            ...
                            {/* <div className='col-md-6 mb-5' style={{ display: 'flex', flexDirection: 'column' }}>
                                <div className='card mt-5 mx-3 py-3 text-center card2' style={{ flex: '1' }}>
                                    <h2><MdEmail /></h2>
                                    <h3>Email</h3>
                                    <p>info@vyaparbandhu.com</p>
                                </div>
