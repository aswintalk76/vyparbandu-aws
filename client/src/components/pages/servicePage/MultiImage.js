                                    ...
                                    <>
                                        {
                                            ...
                                            <div className="p-2 mb-2 "  >
                                                ...
                                                <img style={{ borderRadius: "20px" }} src={`${image.filename && image.filename}`} className="mb-1 w-100" alt="No Previous Image" />
                                            </div>
                                            }
                                        {
                                            data?.images.length > 1 && image.filename &&
                                            ...
                                            <div className="p-2 mb-2 col-md-6 "  >
                                                ...
                                                <img style={{ borderRadius: "20px" }} src={`${image.filename && image.filename}`} className="mb-1 w-100 h-75" alt="No Previous Image" />
                                            </div>
