                ...
                if (stepTwoDataIndex === -1) {
                    ...
                    s3.upload(params, async (error, data) => {
                        if (error) {
                            ...
                            document.stepTwoData[stepTwoDataIndex].icon = data.Location;
        ...
        if (req.file) {
            ...
            s3.upload(params, async (error, data) => {
                if (error) {
                    ...
                    objToUpdate.image = data.Location;
                    await doc.save();
            ...
            if (req.file) {
                ...
                s3.upload(params, async (error, data) => {
                    if (error) {
                        ...
                        questionToUpdate.filename = data.Location;
                        await doc.save();
